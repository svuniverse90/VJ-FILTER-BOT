...
API_ID = int(environ.get('API_ID', '39956884'))
API_HASH = environ.get('API_HASH', '031d62aabdbf415f256cd6099aa90fc8')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/ce6e32614ee4413f61a7d-b1dade811f373c2c31.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8356548095').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5849986145').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001998334471').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002186753065')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '8356548095')
...
REFERAL_COUNT = int(environ.get('REFERAL_COUNT', '01')) # number of referal count
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+ExJ0plrehm83ODJl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/telugumovies40 ')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+J8dbExxoDa1iNTQ1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Unknownman040')
